...
# Polls mihomo auto group health; if all nodes dead for 10 min while local
# DNS (127.0.0.1:5353) still answers, logs into s-ui panel and POST restartSb.
# Best-effort, never blocks boot, procd respawned.
...
DEAD_THRESHOLD="${HEAL_DEAD_THRESHOLD:-10}"
